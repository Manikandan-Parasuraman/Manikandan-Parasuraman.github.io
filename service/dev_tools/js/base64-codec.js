document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("generate-btn").addEventListener("click", () => {
        ...
        try {
            const mode = document.getElementById('mode').value; try { output.value = (mode === 'encode') ? btoa(inputVal) : atob(inputVal); } catch(e) { error.textContent = 'Invalid Base64'; error.style.display = 'block'; }
        } catch(e) { 
            console.error(e);
