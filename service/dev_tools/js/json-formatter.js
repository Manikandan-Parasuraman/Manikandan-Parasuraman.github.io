document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("generate-btn").addEventListener("click", () => {
        ...
        try {
            try { const obj = JSON.parse(inputVal); output.value = JSON.stringify(obj, null, 4); error.style.display = 'none'; } catch (e) { error.textContent = 'Invalid JSON'; error.style.display = 'block'; }
        } catch(e) { 
            console.error(e);
